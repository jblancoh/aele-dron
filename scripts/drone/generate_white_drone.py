...
for sx in [-1,1]:
    ...
    cyl('Front vision socket',(sx*.265,-.839,.438),.069,.022,rubber,axis=(0,-1,0))
    cyl('Front vision glass',(sx*.265,-.855,.438),.048,.011,glass,axis=(0,-1,0))
    cyl('Front vision pupil',(sx*.265,-.862,.438),.026,.002,dark,axis=(0,-1,0))
