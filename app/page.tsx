...
export default function Home(){
 return <MotionProvider><a className="skip-link" href="#catalogo">Saltar al catálogo</a><main id="inicio">
  ...
  <section className="hero" aria-labelledby="hero-title"><div className="hero-shade"/><div className="hero-topline"><span><i/> VIDEOGRAFÍA AÉREA</span><span>VILLAHERMOSA, TABASCO · MÉXICO</span></div>
